...
public class Perez {
    ...
    public static void main(String[] args) {
        try {
            ...
            String username = System.getenv("FTP_USERPEREZ");
...
//            }
    ...
    private static void borrarCarpeta(FTPClient ftp, String carpeta) {
        ...
        try {
            ftp.changeWorkingDirectory("/perez");
    ...
    private static void mostrarFicheros(FTPClient ftp, String carpetaRevisarMD, String carpetaRevisarPNG) {
        ...
        try {
            ftp.changeWorkingDirectory("/perez");//Volvemos a la raiz del usuario

            ftp.changeWorkingDirectory(carpetaRevisarMD);

            System.out.println("FICHEROS DE " + carpetaRevisarMD + " del usuario: " + System.getenv("FTP_USERPEREZ"));
            ...
            System.out.println("FICHEROS DE " + carpetaRevisarPNG + " del usuario: " + System.getenv("FTP_USERPEREZ"));
    ...
    private static FTPClient conexion(){
        try {
            ...
            String username = System.getenv("FTP_USERPEREZ"); //Esto es lo que cambiará
