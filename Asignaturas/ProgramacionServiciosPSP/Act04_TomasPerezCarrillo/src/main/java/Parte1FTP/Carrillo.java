...
public class Carrillo {
    ...
    public static void main(String[] args) {
        try {
            ...
            String username = System.getenv("FTP_USERCARRILLO");
    ...
    private static void mostrarFicheros(FTPClient ftp, String carpetaRevisarMD, String carpetaRevisarPNG) {
        ...
        try {
            ftp.changeWorkingDirectory("/carrillo");//Volvemos a la raiz del usuario

            ftp.changeWorkingDirectory(carpetaRevisarMD);

            System.out.println("FICHEROS DE " + carpetaRevisarMD + " del usuario: " + System.getenv("FTP_USERCARRILLO"));
            ...
            System.out.println("FICHEROS DE " + carpetaRevisarPNG + " del usuario: " + System.getenv("FTP_USERCARRILLO"));
    ...
    private static boolean descargarFichero(FTPClient ftp, String carpetaRemota, String nombreArchivoEnServidor, String rutaLocalDestino, int tipoFichero) throws IOException {
        ...
        ftp.changeWorkingDirectory("/Carrillo");
    ...
    private static FTPClient conexion(){
        try {
            ...
            String username = System.getenv("FTP_USERCARRILLO"); //Esto es lo que cambiará
